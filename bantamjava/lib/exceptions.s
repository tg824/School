...
_label88:
	...
	# MC: modified since no time system call in this version of SPIM
	# email corliss@hws.edu for runtime system and SPIM simulator that 
	# supports time method and system call
	# jal Sys.time
	# MC: added so that random will still kind of work
	li $v0 4273
	la $t0 _random
	sw $v0 0($t0)
