...
public class Main {
	...
	for (int i = 0; i < args.length; i++) {
	    ...
	    // if -dl, -dp, -ds, -di, -do, -dc then set corresponding boolean to enable debugging for that phase
	...
	try {
	    ...
	    // semantic analysis
	    SemanticAnalyzer semanticAnalyzer = new SemanticAnalyzer((Program)result.value, debugSemant);
